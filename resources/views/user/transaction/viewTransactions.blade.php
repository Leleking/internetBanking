        ...
        <div class="panel">
          ...
          <div class="panel-body">
            <table class="table table-hover dataTable table-striped w-full" id="exampleTableTools">
              ...
              <tbody>
              @foreach($cTransaction as $credit)
                <tr>
                  <td>{{$credit->tx_no}}</td>
                  <td>{{$credit->amount}}</td>
                  <td>{{$credit->tx_type}}</td>
                  <td>{{$credit->to_acct}}</td>
               ...
               @endforeach
               @foreach($dTransaction as $debit)
               <tr>
                    <td>{{$debit->tx_no}}</td>
                    <td>{{$debit->amount}}</td>
                    <td>{{$debit->tx_type}}</td>
                    <td>{{$debit->to_acct}}</td>
                    <td>{{Carbon\Carbon::parse($debit->created_at)->format('l jS \of F Y  h:i A')}}</td>
