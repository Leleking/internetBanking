...
<div class="row">
        <div class="col-xl-6 col-lg-12" >
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="card card-block p-25">
                <a href="/user/fund/viewTransactions">
                <div class="counter counter-lg">
            ...
            <div class="card card-block p-0">
              <div class="counter counter-md vertical-align bg-white h-300">
                ...
                <div class="counter-number-group font-size-30 vertical-align-middle">
                  <span class="counter-number">GHC{{auth()->user()->account->balance}}</span>
                  <div class="font-size-20 mt-3">Balance</div>
                </div>
              </div>
            </div>
            <div class="card card-block p-0">
              <div class="vertical-align text-center bg-red-700 white p-30 h-300">
                <div class="vertical-align-middle font-size-40">
                    <div class="font-size-20 mt-3">Generate Token</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <form class="modal-content" name="funds"> 
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <div class="col-xl-6 form-group">
                      <label for="sacct_num"> Senders Account Number</label>
                        <input type="text" class="form-control" name="sacct_num" readonly value="{{auth()->user()->account->acct_num}}">
                      </div>
...
<script>
    ...
    $('#submit').click(function(e){
        e.preventDefault();
       if(ajaxPostFunction('/user/fund/transfer/send')) {
